...
const AICard = ({ data, onPlayDemo }: AICardProps) => {
  ...
  return (
    <Card className="bg-card border-card/50 hover:border-accent/50 transition-all duration-300 hover:shadow-xl hover:shadow-accent/10 hover:-translate-y-1 overflow-hidden group">
      <div className="p-5 space-y-4">
        ...
        {/* Rating and Clicks */}
        <div className="flex items-center justify-between pt-2 border-t border-card-foreground/10">
          <div className="flex items-center gap-3 text-xs">
            <div className="flex items-center gap-1">
              <span className="text-card-foreground/60">Your Rating:</span>
              <span className="font-semibold text-card-foreground">{data.rating}</span>
            </div>
